    ...
    'groups' => [
        ...
        'whm' => [
            ...
            'fields' => [
                ...
                'ssh_host' => ['label' => 'SSH Host (opsional)', 'type' => 'text', 'placeholder' => 'kosongkan untuk pakai host WHM'],
                'ssh_port' => ['label' => 'SSH Port', 'type' => 'text', 'placeholder' => '22'],
                'ssh_user' => ['label' => 'SSH User', 'type' => 'text', 'placeholder' => 'root'],
                'ssh_key' => ['label' => 'SSH Private Key (PEM)', 'type' => 'password'],
            ],
        ],
